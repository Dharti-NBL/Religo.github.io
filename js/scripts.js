(function () {
    ...
    $(window).on("mousewheel DOMMouseScroll", function (event) {
        ...
        var delta = event.originalEvent.deltaY ? -event.originalEvent.deltaY / 3 : event.originalEvent.wheelDelta / 125;
...
$(document).ready(function () {
    ...
    $(".picker_close").click(function () {
        $("#choose_color").toggleClass("position"); // Add/remove 'hidden' class
    });
});
